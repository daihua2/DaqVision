...
| 12 | ★取 `SCA Bearing Dataset` 做可分性/异常检测实验 —— **真实工业现场 + 转速 + 故障标签** | §11.1 | ✅ **已做**（2026-09-19），见 [`research/sca-scalar`](../sca-scalar/README.md)：★速度有效值 + 基线偏离在 10 个真实轴承故障上**基本分不出**；包络 7 例分得开 |
